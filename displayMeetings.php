...
<h1>Previous 10 meetings <a href='meeting_minutes'>(Previous reports)</a></h1>
...
<?php
	...
	print 	"<div class='buttons'>" .
		"\t<button type=\"submit\" class=\"positive\" onclick=\"addNewMeeting()\"> <img src=\"images/addNew.png\"/> New meeting</button>\n" .
		"\t<button type=\"submit\" class=\"positive\" onclick=\"editMeeting()\"> <img src=\"images/authorize.png\"/> Edit meeting</button>\n" .
		"\t<button type=\"submit\" class=\"positive\" onclick=\"deleteMeeting()\"> <img src=\"images/cross.png\"/> Delete meeting</button>\n" .
		"\t<button type=\"submit\" class=\"positive\" onclick=\"report()\"> <img src=\"images/cog.png\"/>Reports</button>\n" .
		"\t<button type=\"submit\" class=\"positive\" onclick=\"manageEmployees()\"> Employees</button>\n" .
		"\t<button type=\"submit\" class=\"positive\" onclick=\"window.location='sign_out.php'\"><img src=\"images/logout.png\"/>Logout</button>\n" .
		"</div>\n";
